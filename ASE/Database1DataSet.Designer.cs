            ...
            public bool IsCustomer {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'IsCustomer\' in table \'People\' is DBNull.", e);
                    }
                }
                set {
...
namespace ASE.Database1DataSetTableAdapters {
...
SELECT ContactID, Name, Company, Email, Telephone, IsCustomer, LastCall FROM People WHERE (ContactID = @ContactID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ASE.Properties.Settings.Default.Database1ConnectionString;
        }
